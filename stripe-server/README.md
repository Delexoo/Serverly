...
1. **`POST /create-checkout-session`** — Creates a [Stripe Checkout](https://stripe.com/docs/payments/checkout) session for **$10 / $20 / $50** (Simple / Advanced / Professional) and stores the wizard answers in **session metadata**.
